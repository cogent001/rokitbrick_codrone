...
IDE_Morph.prototype.setFlatDesign = function () {
    ...
    SpriteMorph.prototype.paletteColor = new Color(248, 248, 243);
    ...
    IDE_Morph.prototype.frameColor = new Color(248, 248, 243);

    IDE_Morph.prototype.groupColor = new Color(232, 232, 222);
    IDE_Morph.prototype.sliderColor = SpriteMorph.prototype.sliderColor;
...
IDE_Morph.prototype.createLogo = function () {
    ...
    this.logo.setExtent(new Point(200, 100)); // dimensions are fixed
    this.add(this.logo);
};
...
IDE_Morph.prototype.newProject = function () {
    ...
    this.currentSprite = new SpriteMorph(this.globalVariables);
    this.sprites = new List([this.currentSprite]);
    StageMorph.prototype.dimensions = new Point(400, 300);
...
IDE_Morph.prototype.setStageExtent = function (aPoint) {
    var myself = this,
        world = this.world(),
        ext = aPoint.max(new Point(400, 300));
...
TurtleIconMorph.prototype.labelColor = new Color(232, 232, 222);
