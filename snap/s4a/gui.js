...
SpriteIconMorph.prototype.userMenu = function () {
    ...
    menu.addLine();
    var myself = this;
    //menu.addItem('connect to Board', function() { myself.object.arduino.attemptConnection() });
    //menu.addItem('disconnect Board', function() { myself.object.arduino.disconnect() });
	return menu;
}
...
IDE_Morph.prototype.snapMenu = function () {
    ...
    menu.addItem('About Rokit brick...', 'aboutRokitbrick');
    menu.addLine();
    menu.addItem(
    ...
    menu.addItem('Rokit brick website',
                 function() {
                     window.open('http://rokitarduino.org', 'RokitbrickWebsite');
                 }
                );
                menu.addItem(
                ...
                menu.addItem(
                    'Rokit brick Codrone repository',
                    function () {
                        window.open(
                            ' https://github.com/cogent001/rokitbrick_codrone.git',
                            'Rokitbrick codrone source'
                        );
                    }
                );
...
IDE_Morph.prototype.aboutRokitbrick = function () {
    var dlg, aboutTxt, translations, cancelBtn,
    module, world = this.world();

    aboutTxt = 'Rokitbrick 1.0 - beta\n\n'
    + 'Copyright \u24B8 2016 Robolink\n'
    + 'contact@robolink.co.kr\n\n'

    + 'Rokitbrick is a modification of Berkley Snap! and Snap4arduino\n'
    + 'developed by the Robolink robotics Labs\n'
    + '(Republic of Korea).\n\n'

    + 'The Robolink robotics labs is comprised of:\n'
    + 'HyeonJong Lee\n'
    + 'ChangYeon Oh\n'
    + 'DoLeyol Lee\n'
    + 'Namsuk Heo\n'
    ...
    dlg = new DialogBoxMorph();
    dlg.inform('About Rokit brick', aboutTxt, world);
    cancelBtn = dlg.addButton(
        function () {
          console.log("cancel!");
          dlg.hide();
        },
...
IDE_Morph.prototype.createLogo = function () {
    ...
    this.logo = new Morph();
    this.logo.texture = 'rokit.png'; // Overriden
    ...
    this.logo.setExtent(new Point(290, 28)); // dimensions are fixed
    this.add(this.logo);
};
